...
class nilai extends AUTH_Controller {
	...
	public function detail() {
		...
		$id 				= trim($_POST['id']);
		$data['nilai'] = $this->M_nilai->select_by_id($id);
		$data['datanilai'] = $this->M_nilai->select_by_nilai($id);

		echo show_my_modal('modals/modal_detail_nilai', 'detail-nilai', $data, 'lg');
	}
	...
	public function export() {
		...
		$objPHPExcel->getActiveSheet()->SetCellValue('B'.$rowCount, "Nama nilai");
		$rowCount++;
